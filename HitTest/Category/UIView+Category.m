...
//    Method orig_pointMethod = class_getClassMethod(self, @selector(pointInside:withEvent:));
//    Method cust_pointMethod = class_getClassMethod(self, @selector(sz_pointInside:withEvent:));
//    method_exchangeImplementations(orig_pointMethod, cust_pointMethod);
//    
//    //交换hitTest:withEvent:方法实现
//    Method orig_hitTestMethod = class_getClassMethod(self, @selector(hitTest:withEvent:));
//    Method cust_hitTestMethod = class_getClassMethod(self, @selector(sz_hitTest:withEvent:));
